...
<template>
    <PengaturanSistemLayout>
        ...
        <div class="space-y-6 rounded-xl border border-[#e6e6e6] bg-white p-6 shadow-sm">
            ...
            <div class="rounded-xl border border-[#e6e6e6] bg-white p-5 shadow-sm">
                ...
                <form class="mt-4 flex flex-col gap-3 sm:flex-row sm:items-start" @submit.prevent="kirimUji">
                    <div class="grid w-full gap-2 sm:max-w-sm">
                        ...
                        <Input id="email_tujuan" v-model="formUji.email_tujuan" type="email" required :class="inp" placeholder="tujuan@domain.com" />
