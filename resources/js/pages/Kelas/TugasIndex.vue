                        ...
                        <table class="tabel-responsif w-full text-left md:min-w-[900px]">
                            ...
                            <tbody class="divide-y divide-[#e6e6e6]">
                                <tr v-for="(item, index) in props.tugas.data" :key="item.id" class="hover:bg-[#f6f5f4]/60">
                                    <td data-label="No." class="px-4 py-3 text-[15px] text-[#615d59]">{{ (props.tugas.from ?? 0) + index }}</td>
                                    <td data-label="Judul" class="px-4 py-3 text-[15px] font-medium text-black">{{ item.judul_tugas }}</td>
                                    ...
                                    <td data-label="Jawaban" class="px-4 py-3 text-center text-[15px] font-semibold text-black">
