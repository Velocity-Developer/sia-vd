...
it('shares the role and permissions of the authenticated user with the frontend', function () {
    ...
    $this->actingAs($dosen)->get(route('dosen.dashboard'))
        ->assertInertia(fn ($page) => $page
            ...
            ->where('auth.permissions', ['dosen.dashboard', 'dosen.kelas-kuliah', 'dosen.jadwal', 'dosen.materi', 'dosen.tugas', 'dosen.quiz', 'dosen.presensi', 'dosen.ujian', 'dosen.mahasiswa-kelas'])
